...
public class Day02 {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        while (scanner.hasNextLine()) {
            ...
            if (shapes.get(compare[0]).equals(shapes.get(compare[1]))) {
                score += draw;
            } else if (shapes.get(compare[0]) == 1 && shapes.get(compare[1]) == 2) {
                score += win;
            } else if (shapes.get(compare[0]) == 2 && shapes.get(compare[1]) == 3) {
                score += win;
            } else if (shapes.get(compare[0]) == 3 && shapes.get(compare[1]) == 1) {
                score += win;
            } else {
                score += lose;
            }
            // add the number of the shape even though you lost,won or drew
            score += shapes.get(compare[1]);
        }
